...
public class Right_PP extends OpMode {
    ...
    private final Pose plow1Pose        = new Pose(120, 18, Math.toRadians(270));
    private final Pose plow2Pose        = new Pose(130, 18, Math.toRadians(270));
    private final Pose plow3Pose        = new Pose(135, 18, Math.toRadians(270));
    ...
    private final Pose plow1ControlPose3     = new Pose(92 , 80);
    private final Pose plow1ControlPose4     = new Pose(123, 89);

    private final Pose plow2ControlPose1     = new Pose(115, 90);
    private final Pose plow2ControlPose2     = new Pose(137, 60);

    private final Pose plow3ControlPose1     = new Pose(114, 70);
    ...
    public void buildPaths(){
        ...
        plow = follower.pathBuilder()
                ...
                .addPath(new BezierCurve(
                        ...
                        new Point(plow3ControlPose2),
                        new Point(plow3ControlPose3),
                        new Point(135, 60)))
                .setConstantHeadingInterpolation(Math.toRadians(270))
                .addPath(new BezierLine(
                        new Point(135, 60),
...
//                    );
                ...
                break;
            case 2:
                if(Math.abs(follower.getPose().getX() - plow3Pose.getX()) < 1 && Math.abs(follower.getPose().getY() - plow3Pose.getY()) < 1){
