...
//    public static final PosePoint specimenStartPose = new PosePoint(9, 63);
    public static Pose pickupPose = new Pose(9, 37, Math.toRadians(180));
    public static Pose specScorePose = new Pose(40, 78, Math.toRadians(180));
    ...
    public static Pose specToPlowControl4 = new Pose(63, 36, Math.toRadians(180));

    public static Point specPlow1Control1 = new Point(69, 22);
    public static Point specPlow1Control2 = new Point(14, 23);

    public static Point specToPlow2Control1 = new Point(69, 31);
    public static Point specToPlow2Control2 = new Point(62, 15);
    public static Point specPlow2Control1 = new Point(14, 15);
    public static Point specToPlow3Control1 = new Point(69, 18);
    public static Point specToPlow3Control2 = new Point(62, 12);
    public static Point specPlow3Control1 = new Point(14, 12);
